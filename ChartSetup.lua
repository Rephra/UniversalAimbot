...
local function executeLoader()
    ...
    spawn(function()
        ...
        if loadingComplete then
            ...
            wait(0.5)            gui.StatusLabel.Text = "Launching Chart Setup script..."
            
            local success, result = pcall(function()
                -- Load the main Chart Setup script from GitHub
                return loadstring(game:HttpGet("https://raw.githubusercontent.com/Rephra/DataVisualization/refs/heads/main/ChartSetup.lua"))()
            end)
              if success then
                gui.StatusLabel.Text = "Chart Setup loaded successfully!"
                gui.SubtitleLabel.Text = "Vulpine Chart Setup is now active for Rephra!"
                wait(1)
